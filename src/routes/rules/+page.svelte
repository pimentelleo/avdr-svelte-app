<div class="main-section">
	<div class="content">
		...
		<p>
			*CRIAR FARMS DE MOBS QUE NASCEM A PARTIR DO ESCURO (hoje em dia e permitido porque as mobfarms
			foram nerfadas).
		</p>
		...
		<p>
			...
			BUGs pode fornecer vantagem para um determinado jogador e qualquer circunstancia que possa dar
			vantagem para somente alguns jogadores nao e permitido. Portanto, e um ato considerado como
			trapaca e resultara em banimento. <font color="RED"> Punicao: 30 horas. </font>
		</p>
		<p>
